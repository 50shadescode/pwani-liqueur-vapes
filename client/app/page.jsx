...
const Page = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center">
        ...
        <p className="text-[#ECC94B] font-black uppercase tracking-[0.3em] text-[10px]">
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="mb-8 bg-[#ECC94B]/5 border border-[#ECC94B]/20 rounded-2xl p-4 flex items-center justify-between">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div className="flex-1">
          <h1 className="text-4xl font-black italic text-[#ECC94B] uppercase tracking-tighter mb-6">
            Live Inventory
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-1 group">
              <Search
                className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-500 group-focus-within:text-[#ECC94B] transition-colors"
                size={18}
              />
              <input
                type="text"
          ...
          >
            ...
            <div className="p-6 flex-grow flex flex-col">
              <div className="flex justify-between items-start mb-2">
                <span className="text-[10px] font-bold text-[#ECC94B] uppercase tracking-[0.2em]">
                  {product.category}
                </span>
                <div className="flex gap-0.5">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      size={10}
                      fill={i < product.rating ? '#ECC94B' : 'none'}
                      className={
                        i < product.rating ? 'text-[#ECC94B]' : 'text-zinc-800'
                      }
                    />
                  ))}
                </div>
              ...
              <div className="pt-4 border-t border-zinc-900 flex justify-between items-center mt-auto">
                <div>
                  ...
                  <p className="text-xl font-black text-white italic">
                    <span className="text-[10px] text-[#ECC94B] not-italic mr-1">
                      KES
                    </span>
                ...
                <button
                  ...
                  className="bg-white text-black p-4 rounded-2xl hover:bg-[#ECC94B] active:scale-95 transition-all transform shadow-xl"
                >
